import {
  App, Plugin, MarkdownView, Modal, PluginSettingTab, Setting
} from 'obsidian';
...
class SampleModal extends Modal {
  ...
  onOpen() {
    ...
    const button = inputContainer.createEl("button", { text: "Search", cls: "ss-query-submit-button" });
    button.onclick = async () => {
      console.debug("searching", input.value);
    };
  }
...
export class SearchModal extends Modal {
  ...
  onOpen() {
	...
	const inputContainer = contentEl.createDiv({ cls: "prompt-input-container" });
    const input = inputContainer.createEl("input", { cls: "prompt-input" });
    input.setAttr("placeholder", "Search for something...");

    // Create the suggestion list
    // const suggestionList = new SuggestionList(contentEl);
    ...
    //   suggestionList.setSuggestions(suggestions);
    // });
